...
const SERVER_FILES = [
    { name: "libnode.lib",    path: "server/deps/nodejs/lib/Release", urlPath: "deps/nodejs/{BRANCH}/x64_win32/Release", os: "x64_win32" },
    { name: "libnode.dll",    path: "server/deps/nodejs/lib/Release", urlPath: "deps/nodejs/{BRANCH}/x64_win32/Release", os: "x64_win32" },
    { name: "libnode.lib",    path: "server/deps/nodejs/lib/Debug",   urlPath: "deps/nodejs/{BRANCH}/x64_win32/Debug",   os: "x64_win32", debugOnly: true },
    { name: "libnode.dll",    path: "server/deps/nodejs/lib/Debug",   urlPath: "deps/nodejs/{BRANCH}/x64_win32/Debug",   os: "x64_win32", debugOnly: true },
    { name: "libnode.so.108", path: "server/deps/nodejs/lib",         urlPath: "deps/nodejs/{BRANCH}/x64_linux",         os: "x64_linux" },
];

(async() => {
    const files = SCOPE === "client" ? CLIENT_FILES : SCOPE === "server" ? SERVER_FILES : CLIENT_FILES.concat(SERVER_FILES);
...
function getCDNInfo(path) {
    return new Promise((resolve, reject) => {
        ...
        https.get(`${basePath}/update.json`, (res) => {
            let data = "";
