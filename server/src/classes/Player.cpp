...
extern js::Class playerClass("Player", &sharedPlayerClass, nullptr, [](js::ClassTemplate& tpl)
{
    ...
    tpl.Mehtod<&alt::IPlayer::Spawn>("spawn");
    tpl.Mehtod<&alt::IPlayer::Despawn>("despawn");
    ...
    tpl.Mehtod<&alt::IPlayer::ClearBloodDamage>("clearBloodDamage");
    tpl.Method("giveWeapon", &GiveWeapon);
    tpl.Method("removeWeapon", &RemoveWeapon);
    tpl.Mehtod<&alt::IPlayer::RemoveAllWeapons>("removeAllWeapons");
    tpl.Mehtod<&alt::IPlayer::SetDateTime>("setDateTime");
    tpl.Mehtod<&alt::IPlayer::SetWeather>("setWeather");
    tpl.Mehtod<&alt::IPlayer::Kick>("kick");
    tpl.Method("getClothes", &GetClothes);
    tpl.Mehtod<&alt::IPlayer::SetClothes>("setClothes");
    tpl.Method("getDlcClothes", &GetDlcClothes);
    tpl.Mehtod<&alt::IPlayer::SetDlcClothes>("setDlcClothes");
    tpl.Method("getProps", &GetProps);
    tpl.Mehtod<&alt::IPlayer::SetProps>("setProps");
    tpl.Method("getDlcProps", &GetDlcProps);
    tpl.Mehtod<&alt::IPlayer::SetDlcProps>("setDlcProps");
    tpl.Mehtod<&alt::IPlayer::ClearProps>("clearProps");
    tpl.Mehtod<&alt::IPlayer::IsEntityInStreamingRange>("isEntityInStreamingRange");
    tpl.Mehtod<&alt::IPlayer::SetIntoVehicle>("setIntoVehicle");
    tpl.Mehtod<&alt::IPlayer::PlayAmbientSpeech>("playAmbientSpeech");
    tpl.Mehtod<&alt::IPlayer::SetHeadOverlay>("setHeadOverlay");
    tpl.Mehtod<&alt::IPlayer::RemoveHeadOverlay>("removeHeadOverlay");
    tpl.Mehtod<&alt::IPlayer::SetHeadOverlayColor>("setHeadOverlayColor");
    tpl.Method("getHeadOverlay", &GetHeadOverlay);
    tpl.Mehtod<&alt::IPlayer::SetFaceFeature>("setFaceFeatureScale");
    tpl.Mehtod<&alt::IPlayer::GetFaceFeatureScale>("getFaceFeatureScale");
    tpl.Mehtod<&alt::IPlayer::RemoveFaceFeature>("removeFaceFeature");
    tpl.Method("setHeadBlendPaletteColor", &SetHeadBlendPaletteColor);
    tpl.Mehtod<&alt::IPlayer::GetHeadBlendPaletteColor>("getHeadBlendPaletteColor");
    tpl.Method("playAnimation", &PlayAnimation);
    tpl.Mehtod<&alt::IPlayer::ClearTasks>("clearTasks");
