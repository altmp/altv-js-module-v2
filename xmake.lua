...
target("v8pp")
    ...
    set_configvar("V8PP_PLUGIN_INIT_PROC_NAME", "")
...
target("server")
    ...
    add_includedirs("server/src", "server/deps", "server/deps/nodejs/include", "server/deps/nodejs/deps/v8/include", "shared/src", "deps/cpp-sdk", "deps/v8pp", "tools/out")
    add_deps("shared")
...
target("client")
    ...
    add_includedirs("client/src", "client/deps", "client/deps/v8/include", "shared/src", "deps/cpp-sdk", "deps/v8pp", "tools/out")
    add_deps("shared")
    add_rules("generate-bindings", "update-deps")
